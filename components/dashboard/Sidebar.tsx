...
export default function Sidebar() {
  ...
  return (
    <>
      {/* Mobile top bar */}
      <div className="lg:hidden sticky top-0 z-30 flex items-center justify-between h-14 px-4 border-b border-gray-200 bg-white gap-2">
        <Link href="/" className="flex items-center gap-2 min-w-0 shrink-0">
          <Logo />
          <span className="font-bold text-xs text-gray-900 tracking-tight whitespace-nowrap truncate">AFROTECHCUTS</span>
        </Link>
        <button
          onClick={() => setOpen(true)}
          className="shrink-0 p-2 -mr-2 rounded-lg text-gray-500 hover:text-gray-900 hover:bg-gray-100 transition-colors"
