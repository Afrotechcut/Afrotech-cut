      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-gray-500 leading-relaxed">The UK's booking platform for Afro hair specialists.</p>
          </div>
        ...
        <div className="mt-10 pt-8 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-gray-400">Built for Afro hair specialists.</p>
        </div>
      </div>
    </footer>
  );
