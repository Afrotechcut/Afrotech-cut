...
export default function SearchPage() {
  ...
  const fetchBarbers = useCallback(async (lng: number, lat: number, r: number, rating: number | null, price: number | null) => {
    setLoading(true);
    try {
  ...
  useEffect(() => {
    ...
    debounceRef.current = setTimeout(() => {
      fetchBarbers(center[0], center[1], radius, minRating, maxPrice);
    }, 300);
  }, [center, radius, minRating, maxPrice, fetchBarbers]);
