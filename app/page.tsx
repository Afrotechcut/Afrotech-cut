        ...
        <section className="relative min-h-[88vh] flex items-center overflow-hidden bg-gray-950">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <div className="max-w-2xl">
              <p className="text-brand-400 text-sm font-semibold uppercase tracking-widest mb-6">The UK's platform for Black barbers &amp; Afro hair</p>
              ...
              <p className="text-lg text-gray-300 mb-10 leading-relaxed max-w-lg">
                Discover Black barbers near you who specialise in Afro hair — fades, locs, twists, and cornrows. Browse their work, get AI-powered style suggestions, and book in seconds. No phone calls. No walk-ins.
              </p>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-gray-500 text-base leading-relaxed mb-8">
                  Take a photo with your camera or upload one. Our AI analyses your face shape and recommends 3–5 Afro-hair styles specifically suited to your features — from fades and twist-outs to locs and cornrows. Each suggestion shows an image of the style and links to Black barbers nearby who specialise in it.
                </p>
                <Link
                  href="/style-match"
              ...
              <div className="relative h-96 rounded-2xl overflow-hidden bg-gray-100">
                <Image
                  ...
                  alt="Black barber cutting a client's Afro-textured hair"
                  fill
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div className="relative h-80 rounded-2xl overflow-hidden bg-gray-800">
                <Image
                  src="https://images.unsplash.com/photo-1686671805337-7d8aa64b965f?w=800&q=80&fit=crop"
                  alt="Black barbershop"
                  fill
              ...
              <div>
                ...
                <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6 leading-tight">Your shop, on the map.<br />Your chair, never empty.</h2>
                <p className="text-gray-400 text-base leading-relaxed mb-8">
                  Get discovered by customers actively searching for a barber who specialises in Afro hair. Manage bookings, track repeat clients, showcase your work, and understand how your shop is performing — all in one dashboard.
                </p>
                <Link
